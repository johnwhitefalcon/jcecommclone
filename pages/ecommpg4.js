...
setResult(green)
  ...
  return (
    <div className="bg-black text-white text-3xl font-extrabold h-screen flex items-center justify-center">
      ...
      <div className="space-y-5 fixed z-10 ml-[-40rem] mt-[0rem]">{result}</div>
      ...
      <div className="space-y-5 fixed z-10 ml-[-12rem] mt-[0rem]">{result}</div>
      ...
      <div className="space-y-5 fixed z-10 ml-[15rem] mt-[0rem]">{result}</div>
